...
headingLable=Label(root, text="Maths Quiz", font=('arial',15))
headingLable.grid(row=0,column=0) 

questionLabel=Label(root, text=question.get())
questionLabel.grid(row=2, column=0)

questionScale= Scale(root, from_=0, to=10,orient=HORIZONTAL,length=300,variable=questionNumber)
questionScale.grid(row=2, column=0)
...
submitButton=Button(root, text="Restart", font=('arial',15) ,command=restart)
